...
$H$ is a lower bound on eigenvalues of all the Hessians of the constraints at all points in the domain.
...
\begin{thm}
Online Gradient Descent with step sizes $\eta_{t}=\frac{1}{\alpha_{t}}$ achives the following guarantee, for all $T\ge1$
